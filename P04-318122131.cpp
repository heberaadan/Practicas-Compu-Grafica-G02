...
int main()
{
	...
	*/
	...
	glm::mat4 cuerpo(1.0);//Inicializar matriz de Modelo 4x4
	glm::mat4 head(1.0);//Inicializar matriz de Modelo 4x4
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.478f, 0.255f, 0.067f); // 0.478, 0.255, 0.067
		...
		model = glm::translate(model, glm::vec3(5.0f, 0.0f, 0.0f)); // Para que se dibuje a partir del centro de la esfera
		...
		model = glm::translate(model, glm::vec3(2.5f, 2.0f, 0.0f)); // Para que se dibuje a partir del centro de la esfera
		model = glm::rotate(model, glm::radians(-15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		head = model;
		model = glm::scale(model, glm::vec3(7.0f, 4.0f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::translate(model, glm::vec3(2.0f, -1.0f, 0.0f)); // Para que se dibuje a partir del centro de la esfera
		model = glm::rotate(model, glm::radians(-60.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(7.0f, 2.5f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.478f, 0.255f, 0.067f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		//_______________COLMILLOS_______________

		model = glm::translate(model, glm::vec3(2.5f, 1.7f, 1.5f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.5f, 1.3f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::translate(model, glm::vec3(2.0f, -0.5f, 0.0f)); // Para que se dibuje a partir del centro de la esfera
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(7.0f, 2.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.42f, 0.23f, 0.060f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = glm::translate(model, glm::vec3(0.0f, 3.0f, 0.0f)); // Para que se dibuje a partir del centro de la esfera
		modelaux = model;
		...
		//_______________________OJOS_____________________________-
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.35f, 0.20f, 0.05f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();
		...
		//___________________________COLMILLOS___________________________
...
// Una difulacción la va a separar por una matriz 