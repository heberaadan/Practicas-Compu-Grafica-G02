...
Sphere sp = Sphere(1.0, 4, 10); //recibe radio, slices, stacks
...
int main()
{
	...
	*/
	...
	camera = Camera(glm::vec3(0.0f, 3.0f, -8.0f), glm::vec3(0.0f, 1.0f, 0.0f), 90.0f, 0.0f, 0.1f, 0.5f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-5.0f, 0.26f, -2.0f));
		...
		*/
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 5.3f, -2.0f));
		model = glm::scale(model, glm::vec3(6.0f, 2.5f, 6.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		*/
		...
		model = glm::translate(model, glm::vec3(1.5f, 2.0f, 0.5f));
		...
		model = glm::scale(model, glm::vec3(1.1f, 2.0f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		meshList[0]->RenderMesh();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.5f, 2.0f, -0.8f));
		model = glm::scale(model, glm::vec3(0.1f, 1.1f, 1.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		meshList[0]->RenderMesh();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.5f, 2.0f, -3.0f));
		model = glm::scale(model, glm::vec3(0.1f, 1.1f, 1.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
