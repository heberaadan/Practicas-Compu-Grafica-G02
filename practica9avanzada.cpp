...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		movHelix -= movHelixoffset * deltaTime;
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f+movHelix, 5.0f+sin(glm::radians(movHeliy)*0.1f), 6.0));
